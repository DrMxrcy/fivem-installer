...
if [[ $install == true ]]; then
  bash <(curl -s https://raw.githubusercontent.com/drmxrcy/fivem-installer/main/install.sh) $runtime_link
else
  bash <(curl -s https://raw.githubusercontent.com/drmxrcy/fivem-installer/main/update.sh) $runtime_link
fi
